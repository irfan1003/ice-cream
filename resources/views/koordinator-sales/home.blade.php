    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Selamat datang kembali! Berikut ringkasan tugas verifikasi Anda hari
                    ini.</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <a href="{{ route('koor.po.index') }}"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 rounded-lg bg-amber-50 flex items-center justify-center text-amber-600 transition-colors group-hover:bg-amber-100">
                    ...
                    <div class="text-right">
                        ...
                        <span
                            class="inline-flex items-center text-xs font-bold text-amber-700 mt-2 bg-amber-50 px-2 py-0.5 rounded">
                            Pending
                        </span>
                    </div>
                </div>
                <div
                    class="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-slate-600 group-hover:text-slate-900 transition-colors">
            ...
            <a href="{{ route('koor.orders.index') }}"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600 transition-colors group-hover:bg-blue-100">
                        ...
                        <div>
                            <p class="text-xs font-bold text-slate-500 uppercase tracking-wider">Pesanan</p>
                            <p class="text-sm text-slate-400 mt-0.5">Menunggu Verifikasi Anda</p>
                        </div>
                    </div>
                    <div class="text-right">
                        ...
                        <span
                            class="inline-flex items-center text-xs font-bold text-blue-700 mt-2 bg-blue-50 px-2 py-0.5 rounded">
                            Pending
                        </span>
                    </div>
                </div>
