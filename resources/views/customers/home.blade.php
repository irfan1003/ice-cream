...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Pesanan Saya</h1>
                <p class="text-sm text-slate-500 mt-1">Pantau status dan riwayat pesanan Anda.</p>
            </div>
        </div>
                ...
                <div class="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
                    ...
                    <div id="rejectionSection" class="hidden">
                        <div class="bg-rose-50 border border-rose-100 rounded-lg p-4">
                            <p class="text-[10px] font-bold text-rose-400 uppercase tracking-widest mb-1">Catatan Penolakan
                            </p>
                        ...
                        <div class="border border-slate-100 rounded-lg overflow-hidden">
                            <table class="w-full text-left text-sm border-collapse">
                                ...
                                <tfoot class="bg-slate-50/50">
                                    ...
                                    <tr class="font-bold text-slate-900">
                                        <td colspan="3" class="px-4 py-3 text-right">Grand Total</td>
                                        <td class="px-4 py-3 text-right text-pink-600 text-base" id="poModalGrandTotal">
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
