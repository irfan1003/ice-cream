        ...
        <div class="flex-1 flex flex-col min-w-0 bg-white">
            ...
            <div class="p-6 border-b border-slate-100 space-y-6">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Katalog Purchase Order</h1>
                        <p class="text-sm text-slate-500">Pesan stok es krim Anda melalui sistem Purchase Order.</p>
                    </div>
                ...
                <div class="flex items-center gap-3 overflow-x-auto scrollbar-hide -mx-2 px-2 py-1">
                    <button @click="brandFilter = 'all'" :class="brandFilter === 'all' ? 'bg-slate-900 text-white shadow-slate-900/10' :
                    ...
                    <template x-for="brand in uniqueBrands">
                        <button @click="brandFilter = brand" :class="brandFilter === brand ? 'bg-brand-blue text-white shadow-brand-blue/10 border-brand-blue' :
                                    'bg-white border-slate-200 text-slate-600'"
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="flex items-center justify-between pt-2">
                                    ...
                                    <button @click.stop="addToCart(product)"
                                        class="w-10 h-10 rounded-2xl bg-slate-900 text-white flex items-center justify-center shadow-lg transition-all hover:scale-110 active:scale-90 group/btn">
                                        <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div id="cartPanel"
            ...
            <div class="flex-1 overflow-y-auto px-6 space-y-4 scrollbar-hide">
                ...
                <div x-show="cart.length === 0" class="flex flex-col items-center justify-center h-full opacity-30 py-20">
                    ...
                    <p class="text-sm font-bold">Keranjang PO Kosong</p>
                </div>
            </div>
            ...
            <div class="p-6 bg-slate-50/50 space-y-6">
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-base font-black text-slate-900 uppercase tracking-wider">Total P.O</span>
                ...
                <button @click="showSalesModal = true" :disabled="cart.length === 0 || loading"
                    ...
                    <div
                        ...
                        <span class="font-black text-sm uppercase tracking-widest"
                            x-text="loading ? 'Memproses...' : 'Submit P.O Sekarang'"></span>
            ...
            <div @click.away="showSalesModal = false"
                ...
                <div class="p-8 space-y-6">
                    <div class="text-center space-y-2">
                        ...
                        <p class="text-sm text-slate-500">Silakan pilih sales yang akan menangani P.O ini.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex gap-3">
                            ...
                            <button @click="submitPO()" :disabled="!selectedSalesId"
            ...
            return {
                ...
                get filteredProducts() {
                    return this.products.filter(p => {
                        const matchesSearch = p.product_name.toLowerCase().includes(this.searchQuery
                            .toLowerCase());
                ...
                addToCart(product) {
                    // PO can be ordered even if stock is 0
                ...
                async submitPO() {
                    ...
                    const result = await Swal.fire({
                        ...
                        text: "Apakah Anda yakin ingin mengirim Purchase Order ini?",
                        icon: 'question',
                        showCancelButton: true,
                        confirmButtonColor: '#96CBFC',
                        cancelButtonColor: '#FFC2D9',
                        confirmButtonText: 'Ya, Kirim PO!',
                    ...
                    if (result.isConfirmed) {
                        this.loading = true;
                        try {
                            const response = await fetch("{{ route('customers.purchase-order.store') }}", {
                                method: 'POST',
                                headers: {
                            ...
                            if (data.success) {
                                await Swal.fire({
                                    icon: 'success',
                                    title: 'Berhasil!',
                                    text: data.message + ' Nomor PO: ' + data.po_number,
                                    confirmButtonColor: '#96CBFC'
                                });
