...
@section('content')
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-xl border border-slate-100 shadow-sm p-8 text-center">
            <div class="w-20 h-20 bg-brand-pink/10 text-brand-pink-dark rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative group">
                        <canvas id="signature-pad" class="w-full h-48 bg-slate-50 border border-slate-200 rounded-xl cursor-crosshair touch-none transition-colors group-focus-within:border-brand-pink"></canvas>
            ...
            document.getElementById('saveSignature').addEventListener('click', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch('{{ route('gudang.profile.update-signature') }}', {
                            method: 'POST',
                            headers: {
